...
<html lang="en">
  <head>
    ...
    <link rel="icon" href="{{ asset('img/icon/book.png') }}">
  ...
  <nav class="navbar navbar-laravel  navbar-fixed-top ">
    ...
    <div class="container">
        ...
        <div class="col-md-12">
          <div class="panel panel-default">
            <div class="panel-heading">
              <h4>Buku
              <a href="/bukupdf" class="btn btn-info pull-right" style="margin-top: -8px;">Laporan</a>
              <a onclick="addForm()" class="btn btn-primary pull-right" style="margin-top: -8px;">Tambah Buku</a>
              </h4>
            </div>
      ...
      @include('book.form_book', ['categories' => $categories])
    </div> 
      ...
      function editForm(id) {
        ...
        $.ajax({
          ...
          success: function(data) {
            ...
            $('#isbn').val(data.isbn);
            $('#public_year').val(data.public_year);
